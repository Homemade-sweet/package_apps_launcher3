...
public class PixelLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "PixelLauncherModelDelegate";
    ...
    public PixelLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
