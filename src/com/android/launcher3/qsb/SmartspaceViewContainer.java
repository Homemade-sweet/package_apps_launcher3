...
import com.android.launcher3.PixelLauncher;
import com.android.launcher3.PixelLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        PixelLauncher launcher = (PixelLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        PixelLauncherModelDelegate delegate = (PixelLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        PixelLauncher launcher = (PixelLauncher) ActivityContext.lookupContext(getContext());
